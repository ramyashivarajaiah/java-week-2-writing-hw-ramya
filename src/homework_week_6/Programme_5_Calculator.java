...
public class Programme_5_Calculator {
    ...
    //static methods
    public static void addition(int a, int b) { // this  method is with parameter/argument
        int result = a + b;
        System.out.println("The addition of " + a + " and " + b + " is : " + result); // we have done print statement with concatenation
    }

    public static int subtraction(int a, int b) { // this  method is with parameter/argument
        return a - b;
    }
